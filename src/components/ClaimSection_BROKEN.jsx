                    ...
                    {showButton && (
                      ...
                      >
                        {!address ? (
                          ...
                          <button
                            onClick={handleClaim}
                            disabled={isClaiming || (isLoadingClaimCondition && !fallbackClaimCondition) || isLoadingContract || !isCorrectNetwork || !contract || (effectiveClaimCondition && !canClaim) || isCheckingClaimStatus || hasClaimedFromContract || !socialGateUnlocked}
                              className="crt-claim-button"
                              style={{
                                fontFamily: 'IBM Plex Mono',
                                fontWeight: 500,
